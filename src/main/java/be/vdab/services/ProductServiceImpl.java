...
public class ProductServiceImpl implements ProductService {
	...
	public long findAantalProductenMetZoekterm(String zoekterm,
			BigDecimal vanPrijs, BigDecimal totPrijs, Integer vanJaartal,
			Integer totJaartal) {
		List<Product> producten = (List<Product>) productDAO
				.findByTitelContainingAndPrijsBetweenAndJaartalBetweenOrStijlContainingAndPrijsBetweenAndJaartalBetweenOrSchilderNaamContainingAndPrijsBetweenAndJaartalBetween(
						zoekterm, vanPrijs, totPrijs, vanJaartal, totJaartal,
						zoekterm, vanPrijs, totPrijs, vanJaartal, totJaartal,
						zoekterm, vanPrijs, totPrijs, vanJaartal, totJaartal);
	...
	public void update(Product product, long id) {
		Product teWijzigenProduct = productDAO.findOne(id);
		teWijzigenProduct.setTitel(product.getTitel());
		teWijzigenProduct.setJaartal(product.getJaartal());
		teWijzigenProduct.setPrijs(product.getPrijs());
		teWijzigenProduct.setStijl(product.getStijl());
		teWijzigenProduct.setSchilder(schilderDAO.findByNaamIs(product.getSchilder()
				.getNaam()));
	}
}
